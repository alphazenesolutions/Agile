...
export default class drsidebar extends Component {
  constructor(props) {
    super();
    this.state = {
      userid: null,
        ...
        <div className="sidebardiv">
          ...
          <div className="itemlinkpage">
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/waitingroom", page: "Personal" }}
              >
                <span>
                  <img src={camera} alt="" />
                </span>{" "}
            ...
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/appointment", page: "Personal" }}
              >
                <span>
            ...
            <div className="pagetitlelinkpage sublink">
              <Link
                className="linkitem"
                to={{ pathname: "/dr_clinictimimg", page: "Personal" }}
              >
                <span>
                  <img src={appointment} alt="" />
                </span>{" "}
            ...
            <div className="pagetitlelinkpage sublink">
              ...
              >
                ...
                Add One-off Clinic Timimg
              </Link>
            </div>
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/connection", page: "Personal" }}
              >
                <span>
            ...
            {/* <div className="pagetitlelinkpage">
                        <Link className="linkitem" to={{ pathname: "/doctor/report", page: "Personal" }}  ><span><img src={camera} alt="" /></span> Reports</Link>
                    </div> */}
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/tutorial", page: "Personal" }}
              >
                <span>
                  <img src={camera} alt="" />
                </span>{" "}
            ...
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/messages", page: "Personal" }}
              >
                <span>
                  <img src={camera} alt="" />
                </span>{" "}
            ...
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/approve", page: "Personal" }}
              >
                <span>
                  <img src={camera} alt="" />
                </span>{" "}
            ...
            <div className="pagetitlelinkpage">
              <Link
                className="linkitem"
                to={{ pathname: "/doctor/notification", page: "Personal" }}
              >
                <span>
              ...
              <div className="col-sm-1">
                <div className="dropdown dropright">
                  ...
                  <div className="dropdown-menu">
                    <a className="dropdown-item" href="/dr_profile">
                      Profile Update
                    </a>
                    <a
