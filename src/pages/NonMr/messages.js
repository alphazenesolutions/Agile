...
import { updateconnection, updateconnectionzero } from "../../apis/connection";
...
export default class messages extends Component {
  ...
  messages = async () => {
    ...
    if (mynotification.length !== 0) {
      for (var x = 0; x < mynotification.length; x++) {
        if (mynotification[x].msg === "New Message") {
          toast.info(
            `You Receive New Message from ${mynotification[x].name}...`,
            {
              autoClose: 2000,
              transition: Slide,
            }
          ...
          await axios
            .delete(
              `${process.env.REACT_APP_SERVER}/notification/${mynotification[x].id}`
            )
            .then((res) => {
              return res.data;
            });
                            ...
                            <div className="card-body">
                              <div className="row">
                                ...
                                <div className="col-sm-4 col-6 mt-3">
                                  ...
                                  >
                                    Message Now{" "}
                                    {connectiondata.connection.from ===
                                    "0" ? null : (
                      ...
                      <div className="row">
                        <div className="col-sm-1 col-1">
                          <span onClick={this.backbtn}>
                            {" "}
                            <MdArrowBack className="BackIcons" />
                          </span>
                        </div>
