...
export default class profile extends Component {
  ...
  render() {
    let { baseLogo, profileurl, initial } = this.state;
    ...
    const { slogo, gender, loader } = this.state;
    return (
      <div className=" row">
        ...
        <div className="col-md-10 profileside">
          ...
          <div className="mt-3 text-end">
            ...
            {loader === false ? <button className="btn addrecep  ml-3" onClick={this.saveprofile}>
              {" "}
              Save & Next Step
