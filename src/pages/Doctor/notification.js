                ...
                <div className="waitingroom">
                    ...
                    {notificationdata.length !== 0 ? notificationdata.map((data, index) => (
                        data.notification.tablename === "Connection" ?
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <div className="col-sm-11 col-9">
                                                    {data.notification.msg === "New" ? <p className="notifcationconten">{data.user.initial}. {data.user.first_name} {data.user.last_name} <b>Connected</b> with You. Now {data.user.gender === "Male" ? "He" : "She"} can make appointments with you.. <br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p> : <p className="notifcationconten"><b>Declined</b> a Connection with {data.user.initial}. {data.user.first_name} {data.user.last_name} . <br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p>}
                            ...
                            </div> : data.notification.tablename === "Single" || data.notification.tablename === "Recurring" || data.notification.tablename === "Instant" ?
                                <div className="row" key={index}>
                                    <div className="col-md-9">
                                        <div className="card notificationcard">
                                            <div className="card-body">
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-11 col-9">
                                                        {data.notification.msg === "New" ? <p className="notifcationconten">{data.user.initial}. {data.user.first_name} {data.user.last_name}  has created <b>{data.notification.tablename} appointment</b> with You On <b>{data.notification.meeting_date}</b>.<br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p> : <p className="notifcationconten">{data.user.initial}. {data.user.first_name} {data.user.last_name}   <b>Resedule a {data.notification.tablename} appointment</b> with You On <b>{data.notification.meeting_date}</b>.<br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p>}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div> : data.notification.tablename === "Waitingroom" ?
                                    <div className="row" key={index}>
                                        <div className="col-md-9">
                                            <div className="card notificationcard">
                                                <div className="card-body">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-11 col-9">
                                                            {data.notification.msg === "New" ? <p className="notifcationconten">{data.user.initial}. {data.user.first_name} {data.user.last_name}  Join a <b>{data.notification.tablename} </b> with You On <b>{data.notification.meeting_date}</b>.<br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p> : <p className="notifcationconten">{data.user.initial}. {data.user.first_name} {data.user.last_name}   <b>Resedule a {data.notification.tablename} appointment</b> with You On <b>{data.notification.meeting_date}</b>.<br /><span className='headingspan'>({moment(data.notification.date).format('MMMM Do YYYY, h:mm:ss a')})</span></p>}
                                    ...
                                    </div> : data.notification.tablename === "Appointment" ? (
                                        <div className="row" key={index}>
                                            <div className="col-md-9">
                                                <div className="card notificationcard">
                                                    <div className="card-body">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-sm-11 col-9">
                                                                <p className="notifcationconten">
                                                                    ...
                                                                    {data.user.last_name} <b>Leaved </b> from Your Waiting room. <br />
