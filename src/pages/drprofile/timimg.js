...
export default class timimg extends Component {
  ...
  savebtn = async () => {
    const { clinic, fromtime, totime, fromdate, userid, dailyslotdata, weeklyslotdata, checkedValue } = this.state;
    if (clinic == null) {
      ...
      if (dailyslotdata.fromtime !== undefined) {
        ...
        for (var i = 0; i < checkedValuenew.length; i++) {
          ...
          await axios.post(`${process.env.REACT_APP_SERVER}/availability/`, data).then((res) => {
            return res.data;
          });
        }
  ...
  updatebtn = async () => {
    const { userid, fromtimeinput, fromtime, totime, fromdate, checkedValue } = this.state;
    ...
    if (checkedValue === undefined) {
      ...
      var clinictimimg = await axios.post(`${process.env.REACT_APP_SERVER}/availability/update/${availability_id}`, data)
        .then((res) => {
          return res.data;
        });
      ...
      var clinictimimgnew = await axios.post(`${process.env.REACT_APP_SERVER}/availability/update/${availability_id}`, datanew)
        .then((res) => {
          return res.data;
        });
  ...
  selectdate = (e) => {
    ...
    if (e.target.id === "Sunday") {
      var data = document.getElementById("Sunday").classList.contains('mystyle');
      if (data === true) {
      ...
      var datamon = document.getElementById("Monday").classList.contains('mystyle');
      if (datamon === true) {
      ...
      var datamontue = document.getElementById("Tuesday").classList.contains('mystyle');
      if (datamontue === true) {
      ...
      var datamontueWed = document.getElementById("Wednesday").classList.contains('mystyle');
      ...
      var Thursdaydata = document.getElementById("Thursday").classList.contains('mystyle');
      ...
      var Fridaydata = document.getElementById("Friday").classList.contains('mystyle');
      if (Fridaydata === true) {
      ...
      var Saturdaydata = document.getElementById("Saturday").classList.contains('mystyle');
  ...
  backbtn = () => {
    window.location.replace("/dr_clinic");
  };
  savebtnedit = async (e) => {
                          ...
                          <div className="col-sm-4 col-4">
                            <div className="row">
                              <div className="col-sm-12 slotdiv">
                                {datafinal.availability.length !== 0 ? datafinal.availability.map((datanew) => (
                                  <>
                                    <span style={{ marginTop: "5px" }}>
                                      {datanew.notes === "Mon" ? "Monday" : datanew.notes === "Tue" ? "Tuesday" : datanew.notes === "Wed" ? "Wednesday":datanew.notes === "Thu" ? "Thursday":datanew.notes === "Fri" ? "Friday":datanew.notes === "Sat" ? "Saturday":datanew.notes === "Sun" ? "Sunday":null}
                                    </span>
                                    <br />
                                  </>
                                )) : null}
              ...
              <div class="modal-dialog">
                <div class="modal-content" style={{ width: "150%" }}>
                  <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Availability</h5>
                        ...
                        ? editdata.availability.map((datafinal, index) => (
                          <div className="card-body mt-2">
                            <div className="row">
                              <div className="col-sm-4 col-4">
                                <span className="clinichead">
                                  {datafinal.notes === "Mon" ? "Monday" : datafinal.notes === "Tue" ? "Tuesday" : datafinal.notes === "Wed" ? "Wednesday":datafinal.notes === "Thu" ? "Thursday":datafinal.notes === "Fri" ? "Friday":datafinal.notes === "Sat" ? "Saturday":datafinal.notes === "Sun" ? "Sunday":null}
                                </span>
                              </div>
                              ...
                              <div className="col-sm-4 col-4">
                                <div className="row">
                                  <div className="col-sm-12">
                                    <input className="timeinput" id={`fromtime${index}`} type="time" defaultValue={datafinal.from_time} />
                                    <input className="timeinput" id={`totime${index}`} type="time" defaultValue={datafinal.to_time} />
                                  </div>
                                </div>
                              </div>
                              <div className="col-sm-4 col-4">
