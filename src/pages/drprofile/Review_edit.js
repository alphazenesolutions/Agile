...
export default class Review_edit extends Component {
  constructor(props) {
    super();
    this.state = {
      initial: null,
  ...
  edithosptitaltimimg = () => {
    window.location.replace("/Timing_dr_edit");
  };
  render() {
    const {
      profileurl,
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      <button className="btn editpersonalbtn">
                        <MdEdit />
                        <Link className="editlink" to="/profile_dr_edit">
                          {" "}
                ...
                <div className="col-sm-4">
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-6 col-6">
                      ...
                      >
                        <MdEdit />{" "}
                        <Link className="editlink" to="/Clinic_edit_dr">
                          Edit Details
                        </Link>
                      </button>
                    </div>
